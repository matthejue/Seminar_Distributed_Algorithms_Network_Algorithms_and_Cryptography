...
\newcommand{\titlelong}{Device Tracking via Linux’s New TCP Source Port Selection Algorithm\cite{kol2022devicetrackinglinuxsnew}}
\newcommand{\titleshort}{Device Tracking Linux}
\newcommand{\subtitlesecond}{Paper by Moshe Kol, Amit Klein and Yossi Gilad}
